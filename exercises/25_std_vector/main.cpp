...
int main(int argc, char **argv) {
    {
        ...
        // std::vector 通常由 3 个指针组成 (begin, end, end_of_storage)，在 64 位系统上是 24 字节。
